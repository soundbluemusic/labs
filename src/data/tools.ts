...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: {
      ...
      ja: "ツール1(Claude版)で生成した韓国語対話を、音読したときどれだけ自然か(朗読適性)を3人が0.1〜5.0で採点し、上位だけを語調(タメ口・敬語・平叙・フォーマル等8種)のバランスとすべての発音(初声・中声・終声)のカバレッジを取って約30分分に厳選したボイスクローン用の録音台本です。韓国語で録音してElevenLabsなどで音声クローンに使えば、多様な抑揚・感情・発音を学習した高品質クローンを作れます。ログイン・インターネット不要で閲覧・コピー・ダウンロードでき、対話が貯まるほど良いものに更新されます。",
    },
    category: {
      ko: "음성 · 오디오",
      en: "Voice · Audio",
