...
export const ui = {
  ko: {
    ...
    siteDescription: 'Claude로 동작하는 도구. Claude에 로그인하면 바로 쓸 수 있습니다.',
    homeHeroTitle: 'Claude로 동작하는 도구',
    homeHeroLead: (n: number) => `Claude에 로그인하면 쓸 수 있는 도구 ${n}개. 아래에서 바로 시작하세요.`,
    homeSectionLabel: '도구',
  ...
  en: {
    siteName: 'labs by soundbluemusic',
    siteDescription: 'Tools that run on Claude. Sign in to Claude and start using them right away.',
    homeHeroTitle: 'Tools powered by Claude',
    homeHeroLead: (n: number) => `${n} tool${n === 1 ? '' : 's'} you can use once you sign in to Claude. Start below.`,
    ...
    notFoundLead: 'The address may have changed, or the page may have been removed.',
  ...
  ja: {
    siteName: 'labs by soundbluemusic',
    siteDescription: 'Claudeで動くツール集。Claudeにログインすればすぐに使えます。',
    homeHeroTitle: 'Claudeで動くツール',
    homeHeroLead: (n: number) => `Claudeにログインすれば使えるツールが${n}個。下からどうぞ。`,
